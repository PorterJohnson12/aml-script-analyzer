## [Week X — 1-on-1 Retrospective] — [07/01/2026]
**What we discussed:** Briefly summarize the key topics covered in the check-in. 
We talked about the proposed project, it's goals, and what needs to be done to see if it's doable.

**Feedback received:** What specific feedback or direction did the instructor give?
Feedback included looking more into the datasets, as well as potential angles for feature extraction. We also spoke about looking into specific models for the project, and potential ways to reach the goal and create business value.

**Action items:** What will you do differently or prioritize as a result?
Now I'm prioritizing looking through the data to make sure it's valuable, as well as determining what models to train and test. I'm also looking further into how to feature extract in a way that's valuable to my goal.

**Reflection:** In one or two sentences — was there anything that surprised you or that you want to think more about?
Not much that surprised me, but I definitely want to think more about how to do this well. Model wise, use wise, and feasibility. I want to think about what would make this valuable to both creatives and executives rather than working for or against one or the other.

## -------------------------------------------------------------------------------------------------------

## [Week 1 — Day 3] — [07/01/2026]

**Worked on:** What did you actually work on today?
Today I worked on looking through datasets and trying to figure out specifics on what I want to do.

**Up next:** What are you working on in the next session?
Next session I'll work on reading through the data I find a bit to see what I have, and what can be done with it.

**Blockers:** Are you facing any challenges or blockers? If none, write "None."
None.


## [Week 1 — Day 4] — [07/02/2026]

**Worked on:** What did you actually work on today?
Today I looked through the datasets, specifically the ScriptBase data, that I have. I have a lot of good info and metadata which helps with specifics on box office and information on films, especially dates.

We did the presentation today and I came away with a lot of good information, as well as potential directions that can make the project a lot more viable.

**Up next:** What are you working on in the next session?
Next session I'm going to work on looking through new datasets and models to try and find something that will allow a deep learning model to work within the scope of this project and goal.

**Blockers:** Are you facing any challenges or blockers? If none, write "None."
Just uncertainty on what I'll find, but no real major issues I can think of right now.

## [Week 1 — Day 5] — [07/03/2026]

**Worked on:** What did you actually work on today?
Today I looked for some datasets that could help make the project more viable, and found a great one called TRIPOD. It has annotated scripts that I can build off of, as well as pretrained models that I can fine tune really well I believe.

**Up next:** What are you working on in the next session?
Looking through the dataset more and evaluating the model, as well as nailing down a stronger proposal before Sunday.
